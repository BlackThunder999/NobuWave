(function() {
    ...
    DOM.registerForm.addEventListener('submit', async (e) => {
        ...
        if (data.user) {
            ...
            DOM.regError.innerHTML = '✅ Готово!<br><small>Перейдите на вкладку <b>Вход</b> и войдите.</small>';
    ...
    async function publish() {
        ...
        try {
            ...
            DOM.postTextarea.value = ''; clearMediaPreviews(); DOM.charCounter.textContent = '0 / 500';
            loadPosts();
